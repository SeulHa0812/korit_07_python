...
# print(age1)
# print(age1 + '10')
# print(type(age1)) # result : <class 'str'>
# age2 = int(age1)
# print(age2 + 10)
...
# input()의 결과값의 자료형은 str이고 그걸 다시 int로 바꾸는 함수가 적용되어 일종의 chaining method처럼 쓸 수 있음
...
'''
age = 18
has_ticket = False # boolean 자료형일 때 python만 또 자기 혼자서 대문자로 시작함
print(type(has_ticket)) # result : <class 'bool'>
...
and : A and B 
or : A or B
not : if not A -> A가 false일 때 실행문 실행
'''